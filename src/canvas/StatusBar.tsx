...
export function StatusBar() {
	...
	return (
		<div className="Qiji-statusbar pointer-events-auto absolute bottom-4 left-4 z-20 flex items-center gap-4 rounded-xl px-3 py-1.5 text-[11px] text-muted-foreground">
