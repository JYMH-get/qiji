...
export const BUILTIN_PROTOCOLS = [
	...
	"jianmeng-video", "openai-video", "volc-mediakit", "sudashui-video", "aistars-video", "aistars-image", "huaying-video", "dimensio-video", "aivide-video", "jianmengp-video", "musem-video", "jmz-video", "jmz-image", "jmt-video", "jmf-video", "overseas-video", "suanli-video", "jmh-image", "jmh-video", "yali-image", "skylee-image", "congge-image", "congge-video", "autodl-video", "stub",
] as const;
